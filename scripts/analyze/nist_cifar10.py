...
nist_01.index = ['Training', 'FGSM', 'PGD', 'TRADES', 'Our Approach']
...
nist_38.index = ['Training', 'FGSM', 'PGD', 'TRADES', 'Our Approach']
...
nist_01.T.plot(ax=ax1, style='o--', linewidth=3, rot=0, legend=False, title="NIST 0/1")
nist_38.T.plot(ax=ax2, style='o--', linewidth=3, rot=0, legend=False, title="NIST 3/8")
cifar_airplanedog.T.plot(ax=ax3, style='o--', linewidth=3, rot=0, legend=False, title="CIFAR10 Airplane/Dog")
cifar_catdog.T.plot(ax=ax4, style='o--', linewidth=3, rot=0, legend=False, title="CIFAR10 Cat/Dog")
ax1.set_ylim(0, 100)
ax1.set_label('xi')
