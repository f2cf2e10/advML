...
for xi in xis:
    ...
    for _ in range(maxIter):
        ...
        #    break
    print()
    torch.save(model_robust_fgsm.state_dict(), "./models/cifar10_dog_airplane_fgsm_xi_{}.pth".format(xi))
    ...
    for _ in range(maxIter):
        ...
        #    break
    print()
    torch.save(model_robust_pgd.state_dict(), "./models/cifar10_dog_airplane_pgd_xi_{}.pth".format(xi))
    ...
    for _ in range(maxIter):
        ...
        #    break
    print()
    torch.save(model_robust_trades.state_dict(), "./models/cifar10_dog_airplane_trades_xi_{}.pth".format(xi))
    ...
    print("Ours\t{:.7f}\t{:.7f}\t{:.7f}\t{:.7f}\t{:.7f}\t{:.7f}\t{:.7f}\t{:.7f}\t{:.7f}\t{:.7f}".format(
        (1 - train_err) * 100, train_loss, (1 - test_err) * 100, test_loss, (1 - adv_sign_err) * 100, adv_sign_loss,
        (1 - adv_pgd_err) * 100, adv_pgd_loss, (1 - adv_trades_err) * 100, adv_trades_loss), end='\r')
    torch.save(our_model.state_dict(), "./models/cifar10_dog_airplane_ours_xi_{}.pth".format(xi))
